...
predPath = r'/storage/brno3-cerit/home/xnantl01/DPDataMSD/gt_segmentations/unetclexp'
...
bestParams = pickle.load(open("/storage/brno3-cerit/home/xnantl01/DP/bestParamExp.pkl","rb"))
...
for i in range(K):
    ...
    opt = torch.optim.Adam(net.parameters(),lr= bestParams["initLR"].item(),weight_decay =  bestParams["weightDecay"].item())
    ...
    with torch.autograd.set_detect_anomaly(True):
        for epoch in tqdm(range(start_epoch,end_epoch)):
            ...
            # LR scheduler
            opt.param_groups[0]['lr'] = bestParams["initLR"].item() * (1 - epoch / end_epoch)**0.9
    ...
    torch.save(foldTraining, "/storage/brno3-cerit/home/xnantl01/DP/modely/UNetClassicExpAugFold{}_{}.pt".format(i,date.today()))       
