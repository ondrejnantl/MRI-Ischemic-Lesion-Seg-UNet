...
hpSpace = {
    'initLR': hp.uniform('initLR', 1e-6, 1e-3),
    'weightDecay': hp.uniform('weightDecay',1e-6,1e-3),
...
# saving them
with open("/storage/brno3-cerit/home/xnantl01/DP/bestParamRes_{}.pkl".format(date.today()), "wb") as outfile:
